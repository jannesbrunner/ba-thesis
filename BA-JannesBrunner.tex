...
\input{sections/01einfuehrung}
\newpage

\input{sections/02grundlagen}
\newpage

\input{sections/03Analyse}
\newpage

\input{sections/04konzept}
\newpage

\input{sections/05implementierung}
\newpage


\input{sections/06fazit}
\newpage

\input{sections/07ausblick}
\newpage
...
\appendix
\thispagestyle{empty}
\input{anhang/funkanf}
%\input{anhang/Nachmessung_Zemente}

\newpage
\thispagestyle{empty}
\input{sections/00selbststaendig}
